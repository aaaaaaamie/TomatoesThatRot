...
- (void)loadMovieDetailView {
    ...
    [self.movieHighResImageView setImageWithURL:imageURL];

    self.movieTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 200, 320, 40)];
    self.movieRateLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 230, 320, 30)];
    self.movieSynopisisLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 260, 320, 980)];
